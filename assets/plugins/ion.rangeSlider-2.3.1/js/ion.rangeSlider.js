...
;(function(factory) {
     ...
     * @constructor
     */
    let IonRangeSlider = function (input, options, plugin_count) {
        this.VERSION = "2.3.1";
        this.input = input;
        ...
        // storage for labels measure letiables
        this.labels = {
            // width
            w_min: 0,
            w_max: 0,
    ...
    IonRangeSlider.prototype = {
         ...
         */
        append: function () {
            let container_html = '<span class="irs irs--' + this.options.skin + ' js-irs-' + this.plugin_count + ' ' + this.options.extra_classes + '"></span>';
        ...
        calc: function (update) {
            ...
            switch (this.target) {
                case "base":
                    let w = (this.options.max - this.options.min) / 100,
